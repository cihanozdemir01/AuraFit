...
class TimerEngine {
      ...
      <div class="active-workout-body">
        ...
        <div class="active-workout-exercise-sec">
          ...
          <div class="active-ex-specs">
            ...
            <div class="spec-pill" id="aw-spec-weight">Ağırlık: <strong id="aw-spec-weight-val">-</strong></div>
          </div>
  ...
  setupActiveExerciseUI() {
    ...
    const weightValEl = document.getElementById('aw-spec-weight-val');
    if (weightValEl) {
      weightValEl.innerText = currentEx.weight || 'Vücut Ağırlığı';
    }
